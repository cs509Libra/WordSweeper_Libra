...
public class TestJoinGameResponseController {
		...
		public void TestJoinGameResponseProcess()
		{
			...
			String xml="<?xml version=\"1.0\" encoding=\"UTF-8\"?><response id=\"someMessageID\" success=\"true\">"
			           + "<joinGameResponse gameId=\"%s\"/></response>";
			xml=String.format(xml,gameid);
			Message m = new Message(xml);
			JoinGameResponseController jgrc=new JoinGameResponseController(client,model);
			assertTrue(jgrc.process(m));
		}
}
//end of TestJoinGameResponseController